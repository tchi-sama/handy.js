 ...
 */
function getAll(q, root = document) {
 ...
 */
function pop(q, root = document) {
  return root.removeChild(get(q, root));
}
 ...
 */
function removeAll(q, root = document) {
  [...getAll(q, root)].forEach(remove);
}
 ...
 */
function append(ele, root = document) {
 ...
 */
function prepend(ele, root = document) {
  root.prepend(ele);
}
 ...
 * innerAll(btn, "<button class="btn"></button>") =>  <button class="btn"><button class="btn"></button></button>
 */
function innerAll(q, content, root = document) {
  [...getAll(q, root)].forEach(ele => inner(ele, content));
}
 ...
 * innerAddAll(btn, "<button class="btn"></button>") =>  <button class="btn"><button class="btn"></button></button>
 */
function innerAddAll(q, content, root = document) {
  [...getAll(q, root)].forEach(ele => innerAdd(ele, content));
}
 ...
 */
function on(ele, type, listener, options) {
 ...
 */
function off(ele, type, listener, options) {
 ...
 */
function once(ele, type, listener, options) {
